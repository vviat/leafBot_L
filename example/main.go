...
func init() {
	...
	//plugins.UseRecall(323760076)            //加载撤回发送私聊
    plugins.UseRecallToGroup(346159858)     //加载撤回发送群组
	//plugins.UseFlashImage(323760076)        //加载闪照破解插件
	plugins.UseFlashImageToGroup(850140472) //加载闪照破解后发到对应群的插件
	plugins.KeyWordRecall(2457444952) //加载关键词撤回
